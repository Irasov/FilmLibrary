package com.epam.irasov.filmlibrary.bd;

import com.epam.irasov.filmlibrary.util.Configuration;
...
public class ConnectionPool {
    ...
    private class PolledConnection implements Connection {
        private Connection connection;

        public PolledConnection(Connection c) throws SQLException {
            this.connection = c;
