...
<div class="nav_user">
    ...
    <ul class="navigation_user">
        ...
        <c:if test="${systemMember.type.id==1}">
        <li><a href="${pageContext.request.contextPath}/operation-with-members-film.jsp">
            <span>
                <fmt:setLocale value="${locale}"/>
                <fmt:setBundle basename="i18n" var="lang"/>
        ...
        <c:if test="${systemMember.type.id==1}">
        <li><a href="${pageContext.request.contextPath}/operation-with-reviews.jsp">
            <span>
                <fmt:setLocale value="${locale}"/>
                <fmt:setBundle basename="i18n" var="lang"/>
        ...
        <c:if test="${systemMember.type.id==1}">
            <li><a href="${pageContext.request.contextPath}/operation-with-news-block.jsp">
            <span>
                <fmt:setLocale value="${locale}"/>
                <fmt:setBundle basename="i18n" var="lang"/>
        ...
        <c:if test="${systemMember.type.id==1}">
            <li><a href="${pageContext.request.contextPath}/operation-with-films-block.jsp">
            <span>
                <fmt:setLocale value="${locale}"/>
                <fmt:setBundle basename="i18n" var="lang"/>
